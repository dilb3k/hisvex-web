...
export default function ProductsPage() {
  ...
  return (
    <div style={{ padding: 0 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              ...
              border: blockCode ? 'none' : '1px solid var(--color-border)',
            }}
            title={blockCode ? 'Blok kodni o\'zgartirish' : 'Blok kod o\'rnatish'}
          >
            {blockCode ? <Lock size={16} color="#fff" /> : <Unlock size={16} color="var(--color-text-secondary)" />}
          </button>
          <button
            onClick={openCreate}
            style={{
      ...
      {/* Block Code Modal */}
      {showBlockModal && (
        <div style={overlay} onClick={() => setShowBlockModal(false)}>
          <div style={{
            background: 'var(--color-surface)',
            borderRadius: 14,
            padding: 24,
