...
export const translations = {
  uz: {
    ...
    settings: 'Sozlamalar',
    settingsSubtitle: 'Hisob, til va tizim sozlamalari',
    users: 'Foydalanuvchilar',
    navSectionOverview: 'Umumiy',
    navSectionOperations: 'Savdo',
    navSectionAdmin: 'Boshqaruv',
    lastActive: "So'nggi faollik",
    lastActiveNever: 'Hali kirmagan',
    lastActiveJustNow: 'Hozir faol',
    lastActiveMinutesAgo: '{n} daqiqa oldin',
    lastActiveHoursAgo: '{n} soat oldin',
    lastActiveDaysAgo: '{n} kun oldin',
    ...
    priceTooHigh: "Narx juda katta",
    applyToCart: 'Butun savatga',
    quantityPositiveRequired: "Miqdor 0 dan katta bo'lishi kerak",
    ...
    cannotAddMoreThanSold: 'Siz sotilgandan ko\'p mahsulot qo\'shyapsiz. Agar yangi mahsulot olib kelgan bo\'lsangiz, qo\'shish sahifasida qo\'shing.',
    ...
    statsThisPeriod: 'Bu davr',
    statsInventoryStatus: 'Ombordagi holat',
    statsInventorySubtitle: 'Agar barcha qoldiq sotilsa',
    statsFullBreakdown: 'To\'liq statistika',
    statsFullBreakdownSubtitle: 'Barcha ko\'rsatkichlar bitta joyda',
    statsRankings: 'Reyting',
    ...
    statsLockedTitle: 'Bu sahifaga kirish uchun obuna talab qilinadi',
    statsLockedBody: 'Statistika — Bor va Pro tarifda mavjud. Mahsulotlar, ombor, savdo va qarzdorlar Tekin tarifda ham to\'liq ishlayveradi.',
    ...
    businessDaySaved: 'Hisob soati saqlandi, ertadan boshlab amal qiladi',
  ...
  ru: {
    ...
    settings: 'Настройки',
    settingsSubtitle: 'Аккаунт, язык и системные настройки',
    users: 'Пользователи',
    navSectionOverview: 'Обзор',
    navSectionOperations: 'Продажи',
    navSectionAdmin: 'Управление',
    lastActive: 'Последняя активность',
    lastActiveNever: 'Ещё не заходил',
    lastActiveJustNow: 'Активен сейчас',
    lastActiveMinutesAgo: '{n} мин. назад',
    lastActiveHoursAgo: '{n} ч. назад',
    lastActiveDaysAgo: '{n} дн. назад',
    ...
    subtotal: 'Итого (без скидки)',
    totalDiscount: 'Общая скидка',
    priceTooHigh: 'Цена слишком большая',
    applyToCart: 'На всю корзину',
    quantityPositiveRequired: 'Количество должно быть больше 0',
    ...
    product: 'Товар',
    noInventory: 'Данные склада на сегодня ещё не готовы',
    cannotAddMoreThanSold: 'Вы добавляете больше товаров, чем было продано. Если вы привезли новые товары, добавьте их на странице добавления.',
    ...
    statsThisPeriod: 'Этот период',
    statsInventoryStatus: 'Состояние склада',
    statsInventorySubtitle: 'Если весь остаток будет продан',
    statsFullBreakdown: 'Полная статистика',
    statsFullBreakdownSubtitle: 'Все показатели в одном месте',
    statsRankings: 'Рейтинг',
    ...
    statsLockedTitle: 'Для доступа к этой странице нужна подписка',
    statsLockedBody: 'Статистика доступна на тарифах Bor и Pro. Товары, склад, продажи и должники продолжают полностью работать и на тарифе Tekin.',
    ...
    businessDaySaved: 'Час расчёта сохранён, действует с завтрашнего дня',
    barcodeNotFound: 'Товар по штрих-коду не найден',
